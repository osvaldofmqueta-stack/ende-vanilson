...
class Tarifa(models.Model):
    ...
    preco_cliente_pos = models.DecimalField(max_digits=10, decimal_places=2, default=0.00, verbose_name="Preço p/ Cliente Pago (fatura)", help_text="Taxa adicional fixa para clientes pagos por fatura")
    preco_cliente_pre = models.DecimalField(max_digits=10, decimal_places=2, default=0.00, verbose_name="Preço p/ Cliente Pago (recarga)", help_text="Taxa adicional fixa para clientes pagos por recarga")
